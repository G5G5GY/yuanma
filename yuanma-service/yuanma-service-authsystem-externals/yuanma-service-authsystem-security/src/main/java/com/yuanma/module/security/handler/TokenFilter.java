...
public class TokenFilter extends GenericFilterBean {
     ...
     */
    public TokenFilter(TokenProvider tokenProvider, SecurityProperties properties, OnlineUserService onlineUserService, UserCacheCleanService userCacheClean) {
    ...
    public void doFilter(ServletRequest servletRequest, ServletResponse servletResponse, FilterChain filterChain)
        ...
        if (StrUtil.isNotBlank(token)) {
            ...
            if (onlineUserDto != null && StringUtils.hasText(token)) {
                ...
                httpServletRequest.setAttribute("uid",tokenProvider.getUid(authentication));
